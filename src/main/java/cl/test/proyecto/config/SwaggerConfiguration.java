package cl.test.proyecto.config;
...
public class SwaggerConfiguration {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("cl.test.proyecto.controller")) //le indico el package donde se encuentran los controladores, si utilizamos any entrega todos
